...
Що я робив, результати і труднощі з якими стикався я описав вище у цьому документі

Загалом що я для себе виніс з цієї лабораторної роботи

Робити контейнери для інтерпритованих мов (python c#) мені здалося легше, бо ми просто запихуємо увесь проект в контейнер, а з компільованими (go) можна погратись і отримати менші образи

Також до написання доверфайлу потрібно підходити з розумом (от же ж неочікуваність) щоб збірка тривала менше і кешування працювало на повну

Працюючи з докером можна бути впевненим що якщо в тебе запустився контейнер і він працює, то у інших він також запуститься, не залежно від OS і фази місяця. 

Ще мене зацікавило як запускати у контейнері застосунок який спілкується з com портом, але це вже думки на майбутнє
